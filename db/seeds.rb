#encoding: utf-8
School.create(name: "ACE TECH HS", address: "5410 S State St")
School.create(name: "AMANDLA HS", address: "6800 S Stewart Ave")
School.create(name: "ASPIRA - EARLY COLLEGE HS", address: "3986 W Barry Ave")
School.create(name: "AUSTIN BUS & ENTRP HS", address: "231 N Pine Ave")
School.create(name: "CHICAGO ARTS HS", address: "2714 W Augusta Blvd")
School.create(name: "CICS - ELLISON HS", address: "1817 W 80th St")
School.create(name: "CICS - LONGWOOD", address: "1309 W 95th St")
School.create(name: "CICS - NORTHTOWN HS", address: "3900 W Peterson Ave")
School.create(name: "CHICAGO MATH & SCIENCE HS", address: "7212 N Clark St")
School.create(name: "CHICAGO VIRTUAL", address: "38 S Peoria St")
School.create(name: "COMMUNITY SERVICES WEST HS", address: "1239 S Pulaski Rd")
School.create(name: "NOBLE - NOBLE HS", address: "1010 N Noble St")
School.create(name: "NOBLE - COMER HS", address: "7200 S Ingleside Ave")
School.create(name: "NOBLE - GOLDER HS", address: "1454 W Superior St")
School.create(name: "NOBLE - PRITZKER HS", address: "4131 W Cortland Ave")
School.create(name: "NOBLE - RAUNER HS", address: "1337 W Ohio St")
School.create(name: "NOBLE - ROWE CLARK HS", address: "3645 W Chicago Ave")
School.create(name: "NOBLE - UIC HS", address: "1231 S Damen Ave")
School.create(name: "NORTH LAWNDALE - CHRISTIANA HS", address: "1615 S. Christiana Ave.")
School.create(name: "NORTH LAWNDALE - COLLINS HS", address: "1313 S Sacramento Dr")
School.create(name: "PERSPECTIVES - LEADERSHIP HS", address: "8131 S May St")
School.create(name: "PERSPECTIVES - TECH HS", address: "8131 S May St")
School.create(name: "PERSPECTIVES - JOSLIN HS", address: "1930 S Archer Ave")
School.create(name: "PERSPECTIVES - MATH & SCI HS", address: "3663 S Wabash Ave")
School.create(name: "PROLOGUE - EARLY COLLEGE HS", address: "1135 N Cleaver St")
School.create(name: "SHABAZZ - DUSABLE HS", address: "4934 S Wabash Ave")
School.create(name: "U OF C - WOODLAWN HS", address: "6420 S University Ave")
School.create(name: "UNO - GARCIA HS", address: "4248 W 47th St")
School.create(name: "URBAN PREP - ENGLEWOOD HS", address: "6201 S Stewart Ave")
School.create(name: "YOUNG WOMENS HS", address: "2641 S Calumet Ave")
School.create(name: "CHICAGO TECH HS", address: "1301 W 14th St")
School.create(name: "EPIC HS", address: "8255 S Houston Ave")
School.create(name: "NOBLE - BULLS HS", address: "2040 W Adams St")
School.create(name: "NOBLE - MUCHIN HS", address: "1 N State St")
School.create(name: "URBAN PREP - WEST HS", address: "1326 W 14th Pl")
School.create(name: "INSTITUTO - HEALTH", address: "2520 S Western Ave")
School.create(name: "URBAN PREP - BRONZEVILLE HS", address: "521 E 35th St")
School.create(name: "NOBLE - JOHNSON HS", address: "6350 S Stewart Ave")
School.create(name: "CICS - HAWKINS HS", address: "801 E 133rd Pl")
School.create(name: "PROLOGUE - JOHNSTON HS", address: "1549 W 95th St")
School.create(name: "CICS - CHICAGOQUEST HS", address: "1443 N Ogden Ave")
School.create(name: "NOBLE - HANSBERRY HS", address: "8748 S Aberdeen St")
School.create(name: "NOBLE - DRW HS", address: "931 S Homan Ave")
School.create(name: "LEGAL PREP HS", address: "4319 W Washington Blvd")
School.create(name: "YCCS - SCHOLASTIC ACHIEVEMENT", address: "4651 W Madison St")
School.create(name: "YCCS - MCKINLEY", address: "2920 S Wabash Ave")
School.create(name: "YCCS - ASPIRA PANTOJA", address: "3121 N Pulaski Rd")
School.create(name: "YCCS - ASSOCIATION HOUSE", address: "1116 N Kedzie Ave")
School.create(name: "YCCS - AUSTIN CAREER", address: "5352 W Chicago Ave")
School.create(name: "YCCS - CCA ACADEMY", address: "1231 S Pulaski Rd")
School.create(name: "YCCS - HOUSTON", address: "6620 S Dr Martin Luther King Jr Dr")
School.create(name: "YCCS - YOUTH DEVELOPMENT", address: "7836 S Union Ave")
School.create(name: "YCCS - CAMPOS", address: "2739 W Division St")
School.create(name: "YCCS - INNOVATIONS", address: "17 N. State St.")
School.create(name: "YCCS - ADDAMS", address: "1814 S Union Ave")
School.create(name: "YCCS - LATINO YOUTH", address: "2001 S California Ave")
School.create(name: "YCCS - OLIVE HARVEY", address: "10001 S Woodlawn Ave")
School.create(name: "LITTLE BLACK PEARL HS", address: "1060 E 47th St")
School.create(name: "YCCS - SULLIVAN", address: "8164 S South Chicago Ave")
School.create(name: "YCCS - TRUMAN", address: "1145 W Wilson Ave")
School.create(name: "YCCS - VIRTUAL", address: "1900 W Van Buren St")
School.create(name: "YCCS - WEST TOWN", address: "500 N Sacramento Blvd")
School.create(name: "YCCS - WESTSIDE HOLISTIC", address: "4909 W Division St")
School.create(name: "YCCS - YOUTH CONNECTION", address: "3424 S State St")
School.create(name: "CAMELOT - CHICAGO EXCEL HS", address: "1257 W 111th St")
School.create(name: "INSTITUTO - LOZANO HS", address: "2570 S Blue Island Ave")
School.create(name: "UNO - SOCCER HS", address: "5025 S Saint Louis Ave")
School.create(name: "YCCS - CHATHAM", address: "9035 S Langley Ave")
School.create(name: "NOBLE - BUTLER HS", address: "821 E 103rd St")
School.create(name: "NOBLE - BAKER HS", address: "2710 E 89th St")
School.create(name: "CHICAGO COLLEGIATE", address: "11816 S Indiana Ave")
School.create(name: "INTRINSIC HS", address: "4540 W Belmont Ave")
School.create(name: "INSTITUTO - LOZANO MASTERY HS", address: "2520 S Western Ave")
School.create(name: "NOBLE - ITW SPEER HS", address: "2456 N. Mango Ave.")
School.create(name: "NOBLE - ACADEMY HS", address: "1443 N Ogden Ave")
School.create(name: "FOUNDATIONS", address: "1233 W. 109th Street")
School.create(name: "PATHWAYS - BRIGHTON PARK HS", address: "3124 W. 47th Street")
School.create(name: "CAMELOT - EXCEL WOODLAWN HS", address: "7530 S South Shore Dr")
School.create(name: "CAMELOT - EXCEL SOUTHWEST HS", address: "7014 S Washtenaw Ave")
School.create(name: "CHICAGO VOCATIONAL HS", address: "2100 E 87th St")
School.create(name: "DUNBAR HS", address: "3000 S King Dr")
School.create(name: "JONES HS", address: "700 S State St")
School.create(name: "PROSSER HS", address: "2148 N Long Ave")
School.create(name: "PAYTON HS", address: "1034 N Wells St")
School.create(name: "RICHARDS HS", address: "5009 S Laflin St")
School.create(name: "NORTH-GRAND HS", address: "4338 W Wabansia Ave")
School.create(name: "SIMEON HS", address: "8147 S Vincennes Ave")
School.create(name: "WESTINGHOUSE HS", address: "3223 W Franklin Blvd")
School.create(name: "HANCOCK HS", address: "4034 W 56th St")
School.create(name: "AMUNDSEN HS", address: "5110 N Damen Ave")
School.create(name: "BOGAN HS", address: "3939 W 79th St")
School.create(name: "FARRAGUT HS", address: "2345 S Christiana Ave")
School.create(name: "FENGER HS", address: "11220 S Wallace St")
School.create(name: "ROBESON HS", address: "6835 S Normal Blvd")
School.create(name: "FOREMAN HS", address: "3235 N LeClaire Ave")
School.create(name: "GAGE PARK HS", address: "5630 S Rockwell St")
School.create(name: "HARLAN HS", address: "9652 S Michigan Ave")
School.create(name: "HARPER HS", address: "6520 S Wood St")
School.create(name: "HIRSCH HS", address: "7740 S Ingleside Ave")
School.create(name: "HYDE PARK HS", address: "6220 S Stony Island Ave")
School.create(name: "KELLY HS", address: "4136 S California Ave")
School.create(name: "KELVYN PARK HS", address: "4343 W Wrightwood Ave")
School.create(name: "KENNEDY HS", address: "6325 W 56th St")
School.create(name: "LAKE VIEW HS", address: "4015 N Ashland Ave")
School.create(name: "LANE TECH HS", address: "2501 W Addison St")
School.create(name: "MANLEY HS", address: "2935 W Polk St")
School.create(name: "MARSHALL HS", address: "3250 W Adams St")
School.create(name: "MATHER HS", address: "5835 N Lincoln Ave")
School.create(name: "MORGAN PARK HS", address: "1744 W Pryor Ave")
School.create(name: "BROOKS HS", address: "250 E 111th St")
School.create(name: "PHILLIPS HS", address: "244 E Pershing Rd")
School.create(name: "ROOSEVELT HS", address: "3436 W Wilson Ave")
School.create(name: "SCHURZ HS", address: "3601 N Milwaukee Ave")
School.create(name: "SENN HS", address: "5900 N Glenwood Ave")
School.create(name: "STEINMETZ HS", address: "3030 N Mobile Ave")
School.create(name: "SULLIVAN HS", address: "6631 N Bosworth Ave")
School.create(name: "TAFT HS", address: "6530 W Bryn Mawr Ave")
School.create(name: "TILDEN HS", address: "4747 S Union Ave")
...
School.create(name: "WELLS HS", address: "936 N Ashland Ave")
School.create(name: "HUBBARD HS", address: "6200 S Hamlin Ave")
School.create(name: "NORTHSIDE LEARNING HS", address: "3730 W Bryn Mawr Ave")
School.create(name: "SOUTHSIDE HS", address: "7342 S Hoyne Ave")
School.create(name: "KENWOOD HS", address: "5015 S Blackstone Ave")
School.create(name: "YORK HS", address: "2700 S California Ave")
School.create(name: "NORTHSIDE PREP HS", address: "5501 N Kedzie Ave")
School.create(name: "SIMPSON HS", address: "1321 S Paulina St")
School.create(name: "KING HS", address: "4445 S Drexel Blvd")
School.create(name: "CHICAGO AGRICULTURE HS", address: "3857 W 111th St")
School.create(name: "CHICAGO MILITARY HS", address: "3519 S Giles Ave")
School.create(name: "YOUNG HS", address: "211 S Laflin St")
School.create(name: "CURIE HS", address: "4959 S Archer Ave")
School.create(name: "CLEMENTE HS", address: "1147 N Western Ave")
School.create(name: "CARVER MILITARY HS", address: "13100 S Doty Ave")
School.create(name: "CORLISS HS", address: "821 E 103rd St")
School.create(name: "JULIAN HS", address: "10330 S Elizabeth St")
School.create(name: "JUAREZ HS", address: "2150 S Laflin St")
School.create(name: "VAUGHN HS", address: "4355 N Linder Ave")
School.create(name: "HOPE HS", address: "5515 S Lowe Ave")
School.create(name: "GRAHAM HS", address: "2347 S Wabash Ave")
School.create(name: "MARINE LEADERSHIP AT AMES HS", address: "1920 N Hamlin Ave")
School.create(name: "JEFFERSON HS", address: "1100 S Hamilton Ave")
School.create(name: "CLARK HS", address: "5101 W Harrison St")
School.create(name: "DOUGLASS HS", address: "543 N Waller Ave")
School.create(name: "PHOENIX MILITARY HS", address: "145 S Campbell Ave")
School.create(name: "BOWEN HS", address: "2710 E 89th St")
School.create(name: "RABY HS", address: "3545 W Fulton Blvd")
School.create(name: "CHICAGO ACADEMY HS", address: "3400 N Austin Ave")
School.create(name: "SPRY HS", address: "2400 S Marshall Blvd")
School.create(name: "WILLIAMS HS", address: "4934 S Wabash Ave")
School.create(name: "BRONZEVILLE HS", address: "4934 S Wabash Ave")
School.create(name: "SOCIAL JUSTICE HS", address: "3120 S Kostner Ave")
School.create(name: "INFINITY HS", address: "3120 S Kostner Ave")
School.create(name: "MULTICULTURAL HS", address: "3120 S Kostner Ave")
School.create(name: "PEACE AND EDUCATION HS", address: "4946 S Paulina St")
School.create(name: "ORR HS", address: "730 N Pulaski Rd")
School.create(name: "RICKOVER MILITARY HS", address: "5900 N Glenwood Ave")
School.create(name: "LINDBLOM HS", address: "6130 S Wolcott Ave")
School.create(name: "WORLD LANGUAGE HS", address: "3120 S Kostner Ave")
School.create(name: "UPLIFT HS", address: "900 W Wilson Ave")
School.create(name: "DEVRY HS", address: "3300 N Campbell Ave")
School.create(name: "COLLINS HS", address: "1313 S Sacramento Dr")
School.create(name: "AUSTIN POLY HS", address: "231 N Pine Ave")
School.create(name: "MARINE MILITARY HS", address: "145 S Campbell Ave")
School.create(name: "TEAM HS", address: "6201 S Stewart Ave")
School.create(name: "AIR FORCE HS", address: "3630 S Wells St")
School.create(name: "VOISE HS", address: "231 N Pine Ave")
School.create(name: "ALCOTT HS", address: "2957 N Hoyne Ave")
School.create(name: "OGDEN HS", address: "1250 W Erie St")
School.create(name: "SOLORIO HS", address: "5400 S St Louis Ave")
School.create(name: "SOUTH SHORE INTL HS", address: "1955 E 75th St")
School.create(name: "BANNER WEST HS", address: "819 N Leamington Ave")
School.create(name: "PATHWAYS - ASHBURN HS", address: "3284 W 87th St")
School.create(name: "GOODE HS", address: "7651 S Homan Ave")
School.create(name: "CRANE MEDICAL HS", address: "2245 W Jackson Blvd")
School.create(name: "BACK OF THE YARDS HS", address: "2111 W 47th St")
School.create(name: "DISNEY II HS", address: "3900 N Lawndale Ave")
School.create(name: "CAMELOT - EXCEL ENGLEWOOD HS", address: "7141 S Morgan St")
School.create(name: "MAGIC JOHNSON - N LAWNDALE HS", address: "3222 W Roosevelt Rd")
School.create(name: "MAGIC JOHNSON - ROSELAND HS", address: "10928 S. Halsted Ave")
School.create(name: "PATHWAYS - AVONDALE HS", address: "3100 W Belmont Ave")
School.create(name: "OMBUDSMAN - NORTHWEST HS", address: "7500 N Harlem Ave")
School.create(name: "OMBUDSMAN - SOUTH HS", address: "6057 S. Western Ave")
School.create(name: "OMBUDSMAN - WEST HS", address: "2401 W. Congress Pkwy")
School.create(name: "PROLOGUE - WINNIE MANDELA HS", address: "7847 S Jeffery Blvd")
School.create(name: "MAGIC JOHNSON - ENGLEWOOD HS", address: "845 W. 69th Street")
School.create(name: "MAGIC JOHNSON - HUMBOLDT PK HS", address: "2421 W. Division")
School.create(name: "CAMELOT SAFE HS", address: "7877 S Coles Ave")
School.create(name: "CAMELOT SAFE - GARFIELD HS", address: "230 N. Kolmar Ave")
School.create(name: "MAGIC JOHNSON - BRAINERD HS", address: "8908 S. Ashland Ave")
School.create(name: "ASPIRA - BUSINESS & FINANCE HS", address: "2989 N. Milwaukee Ave")
...
Attendance.create(event_id: 120, student_id: User.first.id, departure_type: "Early", commitment_status: "Yes", method_of_transit: "bicycling")
Attendance.create(event_id: 125, student_id: User.first.id, departure_type: nil, commitment_status: "Maybe", method_of_transit: nil)
Attendance.create(event_id: 130, student_id: User.first.id, departure_type: "Early", commitment_status: "Yes", method_of_transit: "walking")
...
Event.create(name: "Rising Stars Gymnastics at Avondale Gymnastics", address: "	3516 W School St", start_date_and_time: "2015-08-13T19:00:00-05:00", duration: 2.5, description: "Children are given the opportunity to succeed, use their imaginative skills, enhance listening capabilities and develop self-esteem and confidence through tumbling, movement exploration, balancing and the development of gross motor skills. Obstacle courses, theme weeks, ribbons, balls, balance beam, bars and vaulting are part of this fun movement education experience. Children start in Twinkle Stars and progress through Rising Stars to Super Stars.", organization_id: 1, event_type: "Gymnastics")
...
Event.create(name: "Chicago Southside Mini Maker Faire", address: "7601 S Cicero Ave", start_date_and_time: "2015-08-08T11:00:00-05:00", duration: 6.0, description: "The 3rd Annual Chicago Southside Mini Maker Faire will take place August 8, 2015 at the Ford City Mall on the southwest side of Chicago. This event will showcase Chicago area makers with a focus on the diversity of people, thought, and making styles that makes Chicago an innovative city of deeds. Featuring makers of all ages and abilities, our goal is to produce one of the most diverse Mini Maker Faires in the world.", organization: Organization.last, event_type: "Other")
Attendance.create(event: Event.find_by(name: "Chicago Southside Mini Maker Faire"), student: Student.find_by(username: "Test User"), departure_type: "Late", commitment_status: "Yes", method_of_transit: "walking")
Attendance.create(event: Event.find_by(name: "Chicago Southside Mini Maker Faire"), student: Student.find_by(username: "cbohl"), departure_type: "Early", commitment_status: "Yes", method_of_transit: "bicycling")
Attendance.create(event: Event.find_by(name: "Chicago Southside Mini Maker Faire"), student: Student.find_by(username: "omnignorant"), departure_type: "Early", commitment_status: "Yes", method_of_transit: "bicycling")
